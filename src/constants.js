...
export const DEEZER_URL=`https://connect.deezer.com/oauth/auth.php?app_id=${DeezerAppId}&redirect_uri=${deezerCallback}&perms=basic_access,email`;
...
export const SPOTIFY_URL = `https://accounts.spotify.com/authorize?client_id=${SpotifyAppId}&response_type=token&redirect_uri=${spotifyCallback}`